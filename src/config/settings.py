...
PROCUREMENT_API_KEY = os.getenv("PROCUREMENT_API_KEY", PUBLIC_DATA_API_KEY)
POPULATION_API_KEY = os.getenv("POPULATION_API_KEY", PUBLIC_DATA_API_KEY)
POPULATION_AGE_API_KEY = os.getenv("POPULATION_AGE_API_KEY", PUBLIC_DATA_API_KEY)
STORE_API_KEY = os.getenv("STORE_API_KEY", PUBLIC_DATA_API_KEY)
AWARD_API_KEY = os.getenv("AWARD_API_KEY", PUBLIC_DATA_API_KEY)
