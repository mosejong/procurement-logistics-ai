...
_ITEM_DETAIL_RULES: list[tuple[str, list[str]]] = [
    ...
    ("전문용역/컨설팅", ["컨설팅", "연구용역", "연구 용역", "학술연구", "지역사회보장계획", "조직진단",
                          ...
                          "통역", "번역", "법률", "세무", "회계", "감사", "평가용역",
                          "수질검사", "토양검사", "환경조사", "안전점검", "정밀안전진단",
                          "교통영향", "경관", "문화재", "수요조사", "인구조사"]),
]
