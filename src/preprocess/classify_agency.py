...
_ITEM_DETAIL_RULES: list[tuple[str, list[str]]] = [
    ...
    ("폐기물/환경",     ["폐기물", "폐합성", "폐매트리스", "음식물류", "생활폐기물", "쓰레기", "재활용"]),
    ("급식/식자재",     ["급식", "식자재", "식품", "부식", "식단", "쌀", "김치"]),
    ("IT장비/전산",     ["pc", "노트북", "프린터", "소프트웨어", "sw", "전산", "시스템",
                          "서버", "네트워크", "it", "컴퓨터", "태블릿", "모니터",
                          "cctv", "그룹웨어", "erp", "홈페이지", "앱"]),
    ("경비/보안",       ["경비", "보안", "순찰", "방범"]),
    ("청소/환경미화",   ["청소", "환경미화", "미화", "청결", "가로청소", "뒷골목청소"]),
    ...
    ("의료/복지용품",   ["위생용품", "의료용품", "의약품", "복지용품", "기저귀", "마스크",
                          "장갑", "소독제", "모자보건", "유축기"]),
    ("행사/운영용역",   ["행사", "축제", "운영", "공연", "이벤트", "진행", "콜센터", "프로그램"]),
    ("조경/녹지관리",   ["조경", "잔디", "수목", "가로수", "녹지", "제초", "제설", "나무"]),
    ...
    ("건설/공사",       ["공사", "건축", "철거", "신축", "증축", "감리", "측량", "재개발", "재건축",
                          "영향평가", "지하안전", "계측"]),
    ("보험/금융",       ["보험가입", "자동차보험", "단체보험", "안전보험", "공제"]),
    ("전문용역/컨설팅", ["컨설팅", "연구용역", "지역사회보장계획", "조직진단", "성과관리", "용도지구"]),
]
